...
class M_Admin extends CI_Model
{
  ...
  {
      $query = $this->db->query("select * from $table_name $orderbylimit"); // cek dulu apakah sudah ada kode di tabel.
  ...
  {
      $kalokasiter= 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz123456789';
      $string = '';
      for ($i = 0; $i < $panjang; $i++) {
        $pos = rand(0, strlen($kalokasiter)-1);
        $string .= $kalokasiter[$pos];
      }
      return $string;
  }
}
