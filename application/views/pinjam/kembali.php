								...
								<table class="table table-striped">
									...
									<tr>
										...
										<?php 
												...
												if($diff > 0 )
												{
													...
													</p><small style="color:#333;">* Untuk '.$jml.' tenant</small>';
												}else{
									...
									<tr>
										...
										<?php
											...
											foreach($pin as $isi)
											{
												$tenant = $this->M_Admin->get_tableid_edit('tbl_tenant','tenant_id',$isi['tenant_id']);
												echo $no.'. '.$tenant->tenant_id.'<br/>';
											$no++;}
...
<h4 class="modal-title"> Pengembalian tenant</h4>
</div>
<div id="modal_body" class="modal-body fileSelection1">
	<table class="table table-striped">
		<tr style="background:yellowgreen">
			<td colspan="3">Data Peminjaman tenant</td>
		</tr>
		<tr>
			<td>No Peminjaman</td>
			<td>:</td>
		...
		<tr>
			...
			<?php
				...
				{
					$tenant = $this->M_Admin->get_tableid_edit('tbl_tenant','tenant_id',$isi['tenant_id']);
					echo $no.'. '.$tenant->tenant_id.' ( '.$tenant->title.' )<br/>';
				$no++;}
