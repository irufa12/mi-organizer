        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="<?php if($this->uri->uri_string() == 'user'){ echo 'active';}?>
                ...
                <a href="<?php echo base_url('user');?>" class="cursor">
                    <i class="fa fa-user"></i> <span>Data Admin</span></a>
			</li>
			<li class="treeview <?php if($this->uri->uri_string() == 'data/kategori'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/lokasi'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/tenanttambah'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/tenantdetail/'.$this->uri->segment('3')){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/tenantedit/'.$this->uri->segment('3')){ echo 'active';}?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
                        ...
                        <a href="<?php echo base_url("data");?>" class="cursor">
                            <span class="fa fa-book"></span> Data tenant
                    ...
                    <li class=" <?php if($this->uri->uri_string() == 'data/lokasi'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/lokasi");?>" class="cursor">
			...
			<?php if($this->session->userdata('level') == 'Anggota'){?>
				...
				<?php if($this->uri->uri_string() == 'data/tenantdetail/'.$this->uri->segment('3')){ echo 'active';}?>">
					<a href="<?php echo base_url("data");?>" class="cursor">
						<i class="fa fa-search"></i>  <span>Cari tenant</span>
					</a>
				</li>
