  ...
  $.extend($.summernote.lang, {
    'tr-TR': {
      ...
      image: {
        ...
        dropImage: 'Resim veya metni bılokasiın',
      ...
      help: {
        ...
        'formatPara': 'Aktif bloğun biçimini paragraf (p) olalokasi değiştirir',
        'formatH1': 'Aktif bloğun biçimini başlık 1 (h1) olalokasi değiştirir',
        'formatH2': 'Aktif bloğun biçimini başlık 2 (h2) olalokasi değiştirir',
        'formatH3': 'Aktif bloğun biçimini başlık 3 (h3) olalokasi değiştirir',
        'formatH4': 'Aktif bloğun biçimini başlık 4 (h4) olalokasi değiştirir',
        'formatH5': 'Aktif bloğun biçimini başlık 5 (h5) olalokasi değiştirir',
        'formatH6': 'Aktif bloğun biçimini başlık 6 (h6) olalokasi değiştirir',
      ...
      specialChar: {
        specialChar: 'ÖZEL KAlokasiTERLER',
        select: 'Özel Kalokasiterleri seçin',
      },
    },
  });
})(jQuery);
